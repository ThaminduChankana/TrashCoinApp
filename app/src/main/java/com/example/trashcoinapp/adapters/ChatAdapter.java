...
import com.example.trashcoinapp.databinding.ItemContainerRecievedMessageBinding;
import com.example.trashcoinapp.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder{
        ...
        void setData(ChatMessage chatMessage){
            ...
            binding.txtReceivedMessage.setText(chatMessage.message);
            binding.txtDateTime.setText(chatMessage.dateTime);
        }
    }
}
